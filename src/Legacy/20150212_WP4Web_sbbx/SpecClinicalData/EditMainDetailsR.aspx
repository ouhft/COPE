<%@ Page Title="" Language="C#" MasterPageFile="~/SpecClinicalRecipientPage.master" AutoEventWireup="true" CodeFile="EditMainDetailsR.aspx.cs" Inherits="SpecClinicalData_EditMainDetailsR" %>
<%@ Register assembly="AjaxControlToolkit" namespace="AjaxControlToolkit" tagprefix="asp" %>
<asp:Content ID="conEditMainDetailsR" ContentPlaceHolderID="SpecimenContents" Runat="Server">
    ...
    <table rules="all" cellpadding="2" cellspacing="2" border="1" style="width: 851px">
            ...
            <tr>
                <td style="width:50%" align="right">
                    <asp:label id="lblTrialID" runat="server"  Font-Size="Small" Text="Select TrialID"  />
                </td>
                <td style="width:50%" align="left">
                    
                    
                    <asp:TextBox runat="server" ID="txtTrialID" Width="50%" MaxLength="7" Enabled="false"  />
            ...
            <tr>
                ...
                <td align="left">
                    <asp:RadioButtonList ID="rblKidneyReceived" runat="server" DataTextField="Text" DataValueField="Value" RepeatDirection="Horizontal" RepeatLayout="Flow" Enabled="false">
                    </asp:RadioButtonList>
            ...
            <tr>
                ...
                <td align="left">
                    <asp:RadioButtonList ID="rblRecipientInformedConsent" runat="server" DataTextField="Text" DataValueField="Value" RepeatDirection="Horizontal" RepeatLayout="Flow" AutoPostBack="false"  Enabled="false" >
            ...
            <tr>
                ...
                <td align="left">
                    <asp:RadioButtonList ID="rblRecipient18Year" runat="server" DataTextField="Text" DataValueField="Value" RepeatDirection="Horizontal" RepeatLayout="Flow" AutoPostBack="false"  Enabled="false">
            ...
            <tr>
                ...
                <td align="left">
                    <asp:RadioButtonList ID="rblRecipientMultipleDualTransplant" runat="server" DataTextField="Text" DataValueField="Value" RepeatDirection="Horizontal" RepeatLayout="Flow" AutoPostBack="false" Enabled="false">
