<%@ Page Title="" Language="C#" MasterPageFile="~/SpecClinicalMasterPage.master" AutoEventWireup="true" CodeFile="EditInspection.aspx.cs" Inherits="SpecClinicalData_EditInspection" %>
<%@ Register assembly="AjaxControlToolkit" namespace="AjaxControlToolkit" tagprefix="asp" %>
<asp:Content ID="conEditInspection" ContentPlaceHolderID="SpecimenContents" Runat="Server">
    ...
    <table rules="all" cellpadding="2" cellspacing="2" border="2" style="width: 851px">
        ...
        <tr>
            <td align="right">
                <asp:label id="lblArterialProblems" runat="server"  Font-Size="Small" Text="Arterial Problems"  />
            </td>
            <td align="left">
        ...
        <tr>
            ...
            <td align="left">
                <asp:Button ID="cmdUpdate" runat="server" Text="Update Data" Height="36px"   UseSubmitBehavior="False" OnClick="cmdUpdate_Click"    />
            ...
            <td colspan="2">
                <asp:GridView ID="GV1" runat="server" AutoGenerateColumns="False" 
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="ArterialProblems" SortExpression="ArterialProblems" HeaderText="Arterial Problems"    />
                    </Columns>
                </asp:GridView>
