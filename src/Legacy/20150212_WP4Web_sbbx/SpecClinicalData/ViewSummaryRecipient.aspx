<%@ Page Title="" Language="C#" MasterPageFile="~/SpecClinicalRecipientPage.master" AutoEventWireup="true" CodeFile="ViewSummaryRecipient.aspx.cs" Inherits="SpecClinicalData_ViewSummaryRecipient" %>
<%@ Register assembly="AjaxControlToolkit" namespace="AjaxControlToolkit" tagprefix="asp" %>
<asp:Content ID="ViewSummaryRecipient" ContentPlaceHolderID="SpecimenContents" Runat="Server">
        <asp:Label runat="server" ID="lblUserMessages" CssClass="Caution" />
                ...
                <table style="width:100%" cellpadding="0" cellspacing="1" border="0" >
                    ...
                    <tr align="center">
                        <td colspan="2" align="center" >
                            <asp:label  id="lblActive" runat="server"  Font-Size="Small"></asp:label>
                        </td>
                           ...
                           <asp:GridView ID="GV1" runat="server" AutoGenerateColumns="False" 
                                ...
                                <Columns>
                                    <asp:HyperLinkField DataTextField="EventName" SortExpression="EventName" HeaderText="Event"
                                        DataNavigateUrlFields="PageLink,TrialID,TrialIDRecipient, PageIdentifier,EventID, DateLink,Event_Date,EventCode " 
                                        DataNavigateUrlFormatString="{0}?TID={1}&TID_R={2}&{3}={4}&{5}={6}&EventCode={7}">
                                    </asp:HyperLinkField>
