<%@ Page Title="" Language="C#" MasterPageFile="~/SpecClinicalRecipientPage.master" AutoEventWireup="true" CodeFile="AddAdvEvent.aspx.cs" Inherits="SpecClinicalData_AddAdvEvent" %>
<%@ Register assembly="AjaxControlToolkit" namespace="AjaxControlToolkit" tagprefix="asp" %>
<asp:Content ID="conAddAdvEvent" ContentPlaceHolderID="SpecimenContents" Runat="Server">
