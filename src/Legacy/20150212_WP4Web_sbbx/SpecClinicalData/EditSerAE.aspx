<%@ Page Title="" Language="C#" MasterPageFile="~/SpecClinicalRecipientPage.master" AutoEventWireup="true" CodeFile="EditSerAE.aspx.cs" Inherits="SpecClinicalData_EditSerAE" %>
<%@ Register assembly="AjaxControlToolkit" namespace="AjaxControlToolkit" tagprefix="asp" %>
<asp:Content ID="conEditSerAE" ContentPlaceHolderID="SpecimenContents" Runat="Server">
    ...
    <table rules="all" cellpadding="2" cellspacing="2" border="1" style="width: 851px">
        ...
        <tr>
            ...
            <td align="left"   style="width:65%">
                ...
                &nbsp;
                <asp:label id="lblSAENumber" runat="server"  Font-Size="Small" Text="SAE Number"  />
                <asp:CheckBox runat="server" ID="chkDataLocked" Visible="false" />
                <asp:label id="lblSerialNumber" runat="server"  Font-Size="Small" Text="" Font-Bold="true"  />
        ...
        <tr>
            ...
            <td align="left">
                <asp:RadioButtonList ID="rblResultDeath" runat="server" DataTextField="Text" DataValueField="Value" RepeatDirection="Horizontal" 
                    AutoPostBack="true" OnSelectedIndexChanged="rblResultDeath_SelectedIndexChanged" RepeatLayout="flow" >
        ...
        <tr>
            ...
            <td align="left">
                <asp:Button ID="cmdUpdate" runat="server" Text="Submit" Height="36px"   UseSubmitBehavior="False" OnClick="cmdUpdate_Click"   />
                <asp:ConfirmButtonExtender ID="cmdUpdate_ConfirmButtonExtender" runat="server" 
                    ConfirmText="" Enabled="True" TargetControlID="cmdUpdate">
                </asp:ConfirmButtonExtender>
            </td>
