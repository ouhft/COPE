<%@ Page Title="" Language="C#" MasterPageFile="~/TopMasterPage.master" AutoEventWireup="true" CodeFile="AddTIDList.aspx.cs" Inherits="OtherArea_AddTIDList" %>
<%@ Register assembly="AjaxControlToolkit" namespace="AjaxControlToolkit" tagprefix="asp" %>
<asp:Content ID="conAddTIDList" ContentPlaceHolderID="cplMainContents" Runat="Server">
            ...
            <td colspan="2">
                <asp:GridView ID="GV1" runat="server" AutoGenerateColumns="False" 
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Email When Donor Added/Kidney Randomised">
                            <ItemTemplate>
                                <asp:CheckBox ID="chkIncluded" runat="server" />
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="TrialIDCreated" Visible="false" >
                            <ItemTemplate>
                                <asp:Label runat="server" id="lblTrialIDCreated"
                                    Text='<%#Bind("TrialIDCreated")%>'>
                                </asp:Label>                                
                            </ItemTemplate>                            
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="Comments" Visible="true" ItemStyle-Width="30%" >
                            <ItemTemplate>
                                <asp:TextBox runat="server" id="txtTrialIDCreatedComments" MaxLength="500" Width="95%"
                                    Text='<%#Bind("TrialIDCreatedComments")%>'>
                                </asp:TextBox>                                
                            </ItemTemplate>                            
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="TrialIDCreatedComments" Visible="false" >
                            <ItemTemplate>
                                <asp:Label runat="server" id="lblTrialIDCreatedComments"
                                    Text='<%#Bind("TrialIDCreatedComments")%>'>
                                </asp:Label>                                
                            </ItemTemplate>                            
                        </asp:TemplateField>                      
