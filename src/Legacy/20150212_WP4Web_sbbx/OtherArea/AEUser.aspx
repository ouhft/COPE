<%@ Page Title="" Language="C#" MasterPageFile="~/TopMasterPage.master" AutoEventWireup="true" CodeFile="AEUser.aspx.cs" Inherits="OtherArea_AEUser" %>
<%@ Register assembly="AjaxControlToolkit" namespace="AjaxControlToolkit" tagprefix="asp" %>
<asp:Content ID="conAEUser" ContentPlaceHolderID="cplMainContents" Runat="Server">
    ...
    <table rules="all" cellpadding="0" cellspacing="0" border="1"   style="width: 800px; font-size: small;"  >
        ...
        <tr align="right">
            ...
            <td   align="left">
                <asp:TextBox runat="server" ID="txtUserPass" Width="50%" MaxLength="45"  TextMode="Password" />
