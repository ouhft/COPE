    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gender', models.CharField(default='M', max_length=1, verbose_name='DO37 gender', choices=[('M', 'DO20 Male'), ('F', 'DO21 Female')])),
                ...
                ('blood_group', models.PositiveSmallIntegerField(blank=True, null=True, verbose_name='DO42 blood group', choices=[(1, 'O'), (2, 'A'), (3, 'B'), (4, 'AB'), (5, 'DO29 Unknown')])),
                ...
                ('systemic_flush_used', models.PositiveSmallIntegerField(blank=True, null=True, verbose_name='DO87 systemic (aortic) flush solution used', choices=[(3, 'HTK'), (2, "Marshall's"), (1, 'UW'), (4, 'Other')])),
                ...
                ('donor_blood_1_EDTA', models.OneToOneField(related_name='donor_blood_1', null=True, blank=True, to='samples.Sample', verbose_name='DO91 db 1.1 edta')),
                ('donor_blood_1_SST', models.OneToOneField(related_name='donor_blood_2', null=True, blank=True, to='samples.Sample', verbose_name='DO92 db 1.2 sst')),
                ('donor_urine_1', models.OneToOneField(related_name='donor_urine_1', null=True, blank=True, to='samples.Sample', verbose_name='DO93 du 1')),
                ('donor_urine_2', models.OneToOneField(related_name='donor_urine_2', null=True, blank=True, to='samples.Sample', verbose_name='DO94 du 2')),
                ...
                ('retrieval_hospital', models.ForeignKey(verbose_name='DO06 donor hospital', blank=True, to='locations.Hospital', null=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_on', models.DateTimeField(default=django.utils.timezone.now)),
                ('record_locked', models.BooleanField(default=False)),
                ('location', models.CharField(max_length=1, verbose_name='OR03 kidney location', choices=[('L', 'OR01 Left'), ('R', 'OR02 Right')])),
                ...
                ('preservation', models.PositiveSmallIntegerField(blank=True, null=True, choices=[(0, 'HMP'), (1, 'HMP O2')])),
                ...
                ('perfusate_1', models.ForeignKey(related_name='kidney_perfusate_1', verbose_name='OR60 p1', blank=True, to='samples.Sample', null=True)),
                ('perfusate_2', models.ForeignKey(related_name='kidney_perfusate_2', verbose_name='OR60 p2', blank=True, to='samples.Sample', null=True)),
                ('perfusate_3', models.ForeignKey(related_name='kidney_perfusate_3', verbose_name='OR61 p3', blank=True, to='samples.Sample', null=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('type', models.CharField(max_length=5, verbose_name='PR11 resource used', choices=[('D', 'PR01 Disposables'), ('C-SM', 'PR02 Extra cannula small (3mm)'), ('C-LG', 'PR03 Extra cannula large (5mm)'), ('PH-SM', 'PR04 Extra patch holder small'), ('PH-LG', 'PR05 Extra patch holder large'), ('DB-C', 'PR06 Extra double cannula set'), ('P', 'PR07 Perfusate solution')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('transplant_side', models.CharField(max_length=1, verbose_name='transplant side', choices=[('L', 'OR01 Left'), ('R', 'OR02 Right')])),
                ...
                ('perfusion_technician', models.ForeignKey(related_name='recipient_perfusion_technician_set', verbose_name='DO03 name of transplant technician', blank=True, to='staff_person.StaffPerson', null=True)),
                ('reallocation_recipient', models.OneToOneField(null=True, default=None, blank=True, to='compare.Recipient')),
                ('transplant_coordinator', models.ForeignKey(related_name='recipient_transplant_coordinator_set', verbose_name='DO04 name of the SN-OD', blank=True, to='staff_person.StaffPerson', null=True)),
                ('transplant_hospital', models.ForeignKey(verbose_name='DO06 donor hospital', blank=True, to='locations.Hospital', null=True)),
            ],
            options={
                'ordering': ['sequence_number'],
