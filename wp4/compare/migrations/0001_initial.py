    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_on', models.DateTimeField(default=django.utils.timezone.now)),
                ('record_locked', models.BooleanField(default=False)),
                ('call_received', models.DateTimeField(null=True, verbose_name='RE02 call received from transplant co-ordinator at', blank=True)),
                ('scheduled_start', models.DateTimeField(null=True, verbose_name='RE05 scheduled start', blank=True)),
                ('technician_arrival', models.DateTimeField(null=True, verbose_name='RE06 arrival time at hub', blank=True)),
                ('depart_perfusion_centre', models.DateTimeField(null=True, verbose_name='RE07 departure from hub', blank=True)),
                ('arrival_at_recipient_hospital', models.DateTimeField(null=True, verbose_name='RE08 arrival at transplant hospital', blank=True)),
                ('journey_remarks', models.TextField(verbose_name='RE09 journey notes', blank=True)),
                ('reallocated', models.NullBooleanField(default=None, verbose_name='RE10 reallocated')),
                ('reallocation_reason', models.PositiveSmallIntegerField(blank=True, null=True, verbose_name='RE11 reason for re-allocation', choices=[(1, 'REc01 Positive crossmatch'), (2, 'REc02 Unknown'), (3, 'REc03 Other')])),
                ('reallocation_reason_other', models.CharField(max_length=250, verbose_name='RE12 other reason', blank=True)),
                ('created_by', models.ForeignKey(to=settings.AUTH_USER_MODEL)),
                ('organ', models.ForeignKey(to='compare.Organ')),
                ('perfusion_technician', models.ForeignKey(related_name='recipient_perfusion_technician_set', verbose_name='RO01 name of transplant technician', blank=True, to='staff_person.StaffPerson', null=True)),
                ('reallocation', models.OneToOneField(null=True, default=None, blank=True, to='compare.OrganAllocation')),
                ('theatre_contact', models.ForeignKey(related_name='recipient_transplant_coordinator_set', verbose_name='RE04 name of the theatre contact', blank=True, to='staff_person.StaffPerson', null=True)),
                ('transplant_hospital', models.ForeignKey(verbose_name='RE03 transplant hospital', blank=True, to='locations.Hospital', null=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_of_death', models.DateField(null=True, verbose_name='OP02 date of death', blank=True)),
                ('date_of_death_unknown', models.BooleanField(default=False)),
