    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('start_date', models.DateField(null=True, verbose_name='FB01 start date')),
                ...
                ('organ', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='followup_1y', to='compare.Organ', verbose_name='FY01 Trial id')),
                ('quality_of_life', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='followup_1y', to='health_economics.QualityOfLife', verbose_name='FY08 quality of life')),
            ],
            options={
                'verbose_name': 'FYm1 1 Year FollowUp',
                'verbose_name_plural': 'FYm2 1 Year FollowUps',
                'permissions': (('view_followup1y', 'Can only view the data'), ('restrict_to_national', 'Can only use data from the same location country'), ('restrict_to_local', 'Can only use data from a specific location')),
            },
        ),
        migrations.CreateModel(
            name='FollowUp3M',
            fields=[
                ...
                ('organ', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='followup_3m', to='compare.Organ', verbose_name='F301 Trial id')),
                ('quality_of_life', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='followup_3m', to='health_economics.QualityOfLife', verbose_name='F308 quality of life')),
            ],
            options={
                'verbose_name': 'F3m1 3 Month FollowUp',
                'verbose_name_plural': 'F3m2 3 Month FollowUps',
                'permissions': (('view_followup3m', 'Can only view the data'), ('restrict_to_national', 'Can only use data from the same location country'), ('restrict_to_local', 'Can only use data from a specific location')),
            },
        ),
        migrations.CreateModel(
            name='FollowUp6M',
            fields=[
                ...
                ('organ', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='followup_6m', to='compare.Organ', verbose_name='F601 Trial id')),
            ],
            options={
                'verbose_name': 'F6m1 6 Month FollowUp',
                'verbose_name_plural': 'F6m2 6 Month FollowUps',
                'permissions': (('view_followup6m', 'Can only view the data'), ('restrict_to_national', 'Can only use data from the same location country'), ('restrict_to_local', 'Can only use data from a specific location')),
            },
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('organ', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='followup_initial', to='compare.Organ', verbose_name='FI01 Trial id')),
            ],
            options={
                'verbose_name': 'FIm1 Initial FollowUp',
                'verbose_name_plural': 'FIm2 Initial FollowUps',
                'permissions': (('view_followupinitial', 'Can only view the data'), ('restrict_to_national', 'Can only use data from the same location country'), ('restrict_to_local', 'Can only use data from a specific location')),
            },
        ),
    ]
