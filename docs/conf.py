# -*- coding: utf-8 -*-
#
# COPE DB documentation build configuration file, created by
...
latex_documents = [
    (master_doc, 'COPEDB.tex', u'COPE DB Documentation',
...
man_pages = [
    (master_doc, 'copedb', u'COPE DB Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'COPEDB', u'COPE DB Documentation',
     author, 'COPEDB', 'An online system to support activities for the COPE Consortium clinical trials.',
     'Health / Education'),
]
